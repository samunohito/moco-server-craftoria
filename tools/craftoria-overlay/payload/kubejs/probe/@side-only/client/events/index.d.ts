...
import { $KeyPressedEvent, $KeyBindModifyEvent, $KeyBindEvent } from "@package/com/common/keybindjs/kubejs";
...
import { $AddCapeEventJS } from "@package/dev/thestaticvoid/capejs/kubejs";
...
declare global {
    ...
    namespace KeyBindJSEvents {
        function modify(handler: ((event: $KeyBindModifyEvent) => void)): void;
        function keyRelease(extra: string, handler: ((event: $KeyPressedEvent) => void)): void;
        function keyRelease(handler: ((event: $KeyPressedEvent) => void)): void;
        function keyPressInGui(extra: string, handler: ((event: $KeyPressedEvent) => void)): void;
        function keyPressInGui(handler: ((event: $KeyPressedEvent) => void)): void;
        function firstKeyPressInGui(extra: string, handler: ((event: $KeyPressedEvent) => void)): void;
        function firstKeyPressInGui(handler: ((event: $KeyPressedEvent) => void)): void;
        function firstKeyPress(extra: string, handler: ((event: $KeyPressedEvent) => void)): void;
        function firstKeyPress(handler: ((event: $KeyPressedEvent) => void)): void;
        function keyPress(extra: string, handler: ((event: $KeyPressedEvent) => void)): void;
        function keyPress(handler: ((event: $KeyPressedEvent) => void)): void;
        function keyReleaseInGui(extra: string, handler: ((event: $KeyPressedEvent) => void)): void;
        function keyReleaseInGui(handler: ((event: $KeyPressedEvent) => void)): void;
        function register(handler: ((event: $KeyBindEvent) => void)): void;
    }
    namespace CapeJS {
        function addCapes(handler: ((event: $AddCapeEventJS) => void)): void;
    }
