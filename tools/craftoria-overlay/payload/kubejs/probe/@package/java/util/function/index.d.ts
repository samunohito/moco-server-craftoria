...
declare module "@package/java/util/function" {
     ...
     */
    export type $Supplier_<T> = RegistryTypes.StarcatcherMinigameModifiers | RegistryTypes.StarcatcherCatchModifiers | RegistryTypes.StarcatcherSweetSpotBehaviour | RegistryTypes.StarcatcherBobberSkin | (() => T);
    ...
    export interface $Supplier<T> extends RegistryMarked<RegistryTypes.StarcatcherBobberSkinTag, RegistryTypes.StarcatcherBobberSkin> {}
