import { $Serializable, $PrintStream, $InputStream, $BufferedWriter, $PrintWriter, $BufferedReader, $OutputStream } from "@package/java/io";
import { $Annotation } from "@package/java/lang/annotation";
import { $Configuration, $ModuleDescriptor } from "@package/java/lang/module";
import { $TimeUnit_, $CompletableFuture, $ThreadFactory } from "@package/java/util/concurrent";
...
declare module "@package/java/lang" {
    ...
    export class $Process {
        ...
        waitFor(): number;
        waitFor(arg0: number, arg1: $TimeUnit_): boolean;
