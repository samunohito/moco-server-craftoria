...
declare module "@package/dev/latvian/mods/kubejs/recipe/schema" {
     ...
     */
    export type $RecipeSchemaData$RecipeKeyData_ = { name?: string, defaultOptional?: boolean, role?: $ComponentRole_, optional?: ($JsonElement_) | undefined, functionNames?: $List_<string>, alternativeNames?: $List_<string>, alwaysWrite?: boolean, excluded?: boolean, type?: $RecipeComponent<never>,  } | [name?: string, defaultOptional?: boolean, role?: $ComponentRole_, optional?: ($JsonElement_) | undefined, functionNames?: $List_<string>, alternativeNames?: $List_<string>, alwaysWrite?: boolean, excluded?: boolean, type?: $RecipeComponent<never>, ];
}
