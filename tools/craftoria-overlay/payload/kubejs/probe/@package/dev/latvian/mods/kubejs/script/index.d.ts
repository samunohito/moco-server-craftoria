...
declare module "@package/dev/latvian/mods/kubejs/script" {
    ...
    export class $CodecTypeWrapper<T> extends $Record implements $TypeWrapperFactory<T> {
        ...
        defaultValue(): T;
        codec(): $Codec<T>;
        constructor(target: $Class<T>, codec: $Codec_<T>, defaultValue: T);
    }
    /**
     * Values that may be interpreted as {@link $CodecTypeWrapper}.
     */
    export type $CodecTypeWrapper_<T> = { codec?: $Codec_<any>, defaultValue?: any, target?: $Class<any>,  } | [codec?: $Codec_<any>, defaultValue?: any, target?: $Class<any>, ];
    ...
    export class $TypeWrapperRegistry {
        ...
        registerCodec<T>(target: $Class<T>, codec: $Codec_<T>, defaultValue: T): void;
        registerCodec<T>(target: $Class<T>, codec: $Codec_<T>): void;
        scriptType(): $ScriptType;
        ...
        registerEnumFromStringCodec<T extends $Enum<T>>(target: $Class<T>, codec: $Codec_<T>, defaultValue: T, forceLowerCase: boolean): void;
        registerEnumFromStringCodec<T extends $Enum<T>>(target: $Class<T>, codec: $Codec_<T>): void;
