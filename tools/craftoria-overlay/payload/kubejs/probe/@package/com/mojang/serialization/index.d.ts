...
declare module "@package/com/mojang/serialization" {
    ...
    export interface $MapCodec<A> extends RegistryMarked<RegistryTypes.WorldgenChunkGeneratorTag, RegistryTypes.WorldgenChunkGenerator> {}
    ...
    export class $MapCodec<A> extends $CompressorHolder implements $MapDecoder<A>, $MapEncoder<A> {
        ...
        stable(): $MapCodec<A>;
        static assumeMapUnsafe<A>(arg0: $Codec_<A>): $MapCodec<A>;
     ...
     */
    export type $MapCodec_<A> = RegistryTypes.CreatePotatoProjectileRenderMode | RegistryTypes.WorldgenMaterialRule | RegistryTypes.WorldgenPoolAliasBinding | RegistryTypes.IronsJewelryAction | RegistryTypes.EnchantmentLocationBasedEffectType | RegistryTypes.WorldgenMaterialCondition | RegistryTypes.SpectrumResonanceProcessorType | RegistryTypes.EnchantmentLevelBasedValueType | RegistryTypes.LithostitchedProcessorConditionType | RegistryTypes.LithostitchedFastNoiseConfigType | RegistryTypes.EnchantmentProviderType | RegistryTypes.NeoforgeGlobalLootModifierSerializers | RegistryTypes.LithostitchedLoadPredicateType | RegistryTypes.LithostitchedBiomeInjectorType | RegistryTypes.SpectrumPastelPayloadType | RegistryTypes.NeoforgeBiomeModifierSerializers | RegistryTypes.NeoforgeStructureModifierSerializers | RegistryTypes.CreatePotatoProjectileBlockHitAction | RegistryTypes.LithostitchedModifierType | RegistryTypes.ArsAdditionsMarkData | RegistryTypes.TwilightTravellersModifierType | RegistryTypes.EnchantmentEntityEffectType | RegistryTypes.MoonlightVillagerTrades | RegistryTypes.LithostitchedBandlandsBandType | RegistryTypes.MekanismChemicalIngredientType | RegistryTypes.EnchantmentValueEffectType | RegistryTypes.WorldgenBiomeSource | RegistryTypes.NeoforgeConditionCodecs | RegistryTypes.FunctionalstorageFunctionalUpgradeBehavior | RegistryTypes.CreatePotatoProjectileEntityHitAction | RegistryTypes.ArsAdditionsTagModifiers | RegistryTypes.MekanismRobitSkinSerializer | RegistryTypes.BlockType | RegistryTypes.WorldgenDensityFunctionType | RegistryTypes.EntitySubPredicateType | RegistryTypes.LithostitchedPlacementConditionType | RegistryTypes.WorldgenChunkGenerator;
    export interface $Codec<A> extends RegistryMarked<RegistryTypes.CorgilibBlendingFunctionTag, RegistryTypes.CorgilibBlendingFunction> {}
    ...
    export class $Codec<A> {
        ...
        static list<E>(arg0: $Codec_<E>): $Codec<$List<E>>;
        static list<E>(arg0: $Codec_<E>, arg1: number, arg2: number): $Codec<$List<E>>;
        ...
        static xor<F, S>(arg0: $Codec_<F>, arg1: $Codec_<S>): $Codec<$Either<F, S>>;
        static pair<F, S>(arg0: $Codec_<F>, arg1: $Codec_<S>): $Codec<$Pair<F, S>>;
        static optionalField<F>(arg0: string, arg1: $Codec_<F>, arg2: boolean): $MapCodec<(F) | undefined>;
        static compoundList<K, V>(arg0: $Codec_<K>, arg1: $Codec_<V>): $Codec<$List<$Pair<K, V>>>;
        static unboundedMap<K, V>(arg0: $Codec_<K>, arg1: $Codec_<V>): $UnboundedMapCodec<K, V>;
        ...
        static dispatchedMap<K, V>(arg0: $Codec_<K>, arg1: $Function_<K, $Codec<V>>): $Codec<$Map<K, V>>;
        static stringResolver<E>(arg0: $Function_<E, string>, arg1: $Function_<string, E>): $Codec<E>;
        static withAlternative<T, U>(arg0: $Codec_<T>, arg1: $Codec_<U>, arg2: $Function_<U, T>): $Codec<T>;
        static withAlternative<T>(arg0: $Codec_<T>, arg1: $Codec_<T>): $Codec<T>;
        static either<F, S>(arg0: $Codec_<F>, arg1: $Codec_<S>): $Codec<$Either<F, S>>;
        static intRange(arg0: number, arg1: number): $Codec<number>;
        static floatRange(arg0: number, arg1: number): $Codec<number>;
        static simpleMap<K, V>(arg0: $Codec_<K>, arg1: $Codec_<V>, arg2: $Keyable_): $SimpleMapCodec<K, V>;
    ...
    /**
     * Values that may be interpreted as {@link $Codec}.
     */
    export type $Codec_<A> = RegistryTypes.CorgilibCondition | RegistryTypes.CorgilibBlendingFunction;
