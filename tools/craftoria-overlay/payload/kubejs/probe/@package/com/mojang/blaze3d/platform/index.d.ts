...
import { $GlStateManagerAccessor as $GlStateManagerAccessor$1 } from "@package/net/irisshaders/iris/mixin";
import { $InputStream, $File_ } from "@package/java/io";
import { $GlStateManagerAccessor } from "@package/dev/compactmods/gander/render/mixin";
...
declare module "@package/com/mojang/blaze3d/platform" {
    ...
    export class $GlStateManager implements $GlStateManagerAccessor$1, $GlStateManagerAccessor {
        ...
        static getCOLOR_MASK$iris_$md$f87c94$1(): $GlStateManager$ColorMask;
        static getActiveTexture$iris_$md$f87c94$3(): number;
        static getTEXTURES$iris_$md$f87c94$4(): $GlStateManager$TextureState[];
        ...
        static getBLEND$iris_$md$f87c94$0(): $GlStateManager$BlendState;
        static getDEPTH$iris_$md$f87c94$2(): $GlStateManager$DepthState;
        ...
        static getTEXTURES$ganderrender_$md$f87c94$6(): $GlStateManager$TextureState[];
        static getActiveTexture$ganderrender_$md$f87c94$7(): number;
        ...
        static get COLOR_MASK$iris_$md$f87c94$1(): $GlStateManager$ColorMask;
        static get activeTexture$iris_$md$f87c94$3(): number;
        static get TEXTURES$iris_$md$f87c94$4(): $GlStateManager$TextureState[];
        static get BLEND$iris_$md$f87c94$0(): $GlStateManager$BlendState;
        static get DEPTH$iris_$md$f87c94$2(): $GlStateManager$DepthState;
        static get TEXTURES$ganderrender_$md$f87c94$6(): $GlStateManager$TextureState[];
        static get activeTexture$ganderrender_$md$f87c94$7(): number;
    }
    export class $NativeImage implements $AutoCloseable, $IMixinNativeImage, $NativeImageAccessor {
        ...
        static invoke_class_constructor_FancyMenu$fancymenu_$md$f87c94$0(arg0: $NativeImage$Format_, arg1: number, arg2: number, arg3: boolean, arg4: number): $NativeImage;
        getPointer(): number;
    ...
    export class $InputConstants$Key implements $AccessInputConstantsKey {
        ...
        static getNAME_MAP$controlling_$md$f87c94$0(): $Map<any, any>;
        displayName: $LazyLoadedValue<$Component>;
        get name(): string;
        get value(): number;
        get type(): $InputConstants$Type;
        get numericKeyValue(): $OptionalInt;
        static get NAME_MAP$controlling_$md$f87c94$0(): $Map<any, any>;
    }
    ...
    export class $Window implements $AutoCloseable, $WindowKJS {
        ...
        handler$hge000$relics$getGuiScale(arg0: $CallbackInfoReturnable<any>): void;
        ...
        handler$hge000$relics$getGuiScaledHeight(arg0: $CallbackInfoReturnable<any>): void;
        handler$hge000$relics$getGuiScaledWidth(arg0: $CallbackInfoReturnable<any>): void;
