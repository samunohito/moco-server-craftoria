...
import { $ClientElementsModelAccess } from "@package/commoble/morered/mixin";
...
declare module "@package/net/neoforged/neoforge/client/model" {
     ...
     */
    export class $ElementsModel extends $SimpleUnbakedGeometry<$ElementsModel> implements $ClientElementsModelAccess {
