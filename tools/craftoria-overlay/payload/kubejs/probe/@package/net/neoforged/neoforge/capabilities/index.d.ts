...
import { $RegisterCapabilitiesEventExtension, $BlockCapabilityExtension } from "@package/com/supermartijn642/entangled/extensions";
...
declare module "@package/net/neoforged/neoforge/capabilities" {
     ...
     */
    export class $RegisterCapabilitiesEvent extends $Event implements $IModBusEvent, $ITrackingCapEvent, $RegisterCapabilitiesEventExtension {
        /**
        ...
        entangled_getRegisteredCapabilities(): $Set<any>;
        /**
     ...
     * }
     */
    export class $BlockCapability<T, C> extends $BaseCapability<T, C> implements $BlockCapabilityExtension {
        /**
