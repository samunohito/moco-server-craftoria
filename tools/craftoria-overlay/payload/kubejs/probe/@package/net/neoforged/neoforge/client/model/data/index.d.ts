...
import { $MultipartModelDataAccessor } from "@package/org/embeddedt/embeddium/impl/mixin/features/model";
...
declare module "@package/net/neoforged/neoforge/client/model/data" {
    ...
    export class $MultipartModelData implements $MultipartModelDataAccessor {
        /**
        ...
        static getProperty$embeddium_$md$f87c94$0(): $ModelProperty<any>;
        constructor();
        static get property$embeddium_$md$f87c94$0(): $ModelProperty<any>;
    }
    /**
