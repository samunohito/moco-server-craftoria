...
import { $Decoder$Simple, $DataResult, $DynamicOps, $Codec, $MapLike, $Decoder$Boxed, $Lifecycle, $Encoder, $Codec_, $Dynamic, $MapCodec, $Decoder, $Codec$ResultFunction, $RecordBuilder, $Decoder$Terminal } from "@package/com/mojang/serialization";
...
declare module "@package/net/neoforged/neoforge/common" {
    ...
    export class $LenientUnboundedMapCodec<K, V> implements $BaseMapCodec<K, V>, $Codec<$Map<K, V>> {
        ...
        constructor(keyCodec: $Codec_<K>, elementCodec: $Codec_<V>);
    }
    /**
     ...
     */
    export type $ItemAbility_ = "shield_block" | "ignite" | "sword_sweep" | "till" | "wrench_configure_items" | "light_campfire" | "knife_harvest" | "pickaxe_dig" | "axe_strip" | "axe_scrape" | "shears_dig" | "wrench_configure_energy" | "drill_crack" | "shears_trim" | "shears_entity_use" | "spartan_weaponry_unofficial:melee_block" | "brush_brush" | "spyglass_scope" | "axe_wax_off" | "wrench_configure_fluids" | "shovel_flatten" | "soap_clean" | "shovel_dig" | "shovel_douse" | "create:extinguish_flame" | "trident_throw" | "wrench_configure_heat" | "wrench_configure" | "axe_dig" | "hoe_dig" | "wrench" | "shears_remove_armor" | "wrench_dismantle" | "sword_dig" | "shears_disarm" | "light_fire" | "paxel_dig" | "fishing_rod_cast" | "wrench_rotate" | "shears_harvest" | "shears_carve" | "knife_dig" | "wrench_configure_chemicals" | "firestarter_light" | "wrench_empty";
