...
import { $WoodTypeInvoker } from "@package/com/kekecreations/jinxedlib/core/mixin";
...
declare module "@package/net/minecraft/world/level/block/state/properties" {
    ...
    export class $NoteBlockInstrument extends $Enum<$NoteBlockInstrument> implements $StringRepresentable {
        ...
        static newInstrument$cataclysm_$md$f87c94$0(arg0: string, arg1: number, arg2: string, arg3: $Holder_<any>, arg4: $NoteBlockInstrument$Type_): $NoteBlockInstrument;
        getSerializedName(): string;
    ...
    export class $WoodType extends $Record implements $WoodTypeInvoker {
        name(): string;
        static values(): $Stream<$WoodType>;
        static register(woodType: $WoodType_): $WoodType;
        setType(): $BlockSetType;
        soundType(): $SoundType;
        static invokeRegister$jinxedlib_$md$f87c94$0(woodType: $WoodType_): $WoodType;
