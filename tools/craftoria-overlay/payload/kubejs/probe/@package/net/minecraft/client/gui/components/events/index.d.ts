...
import { $ScreenRectangle, $FocusNavigationEvent$ArrowNavigation_, $FocusNavigationEvent$TabNavigation_, $FocusNavigationEvent_ } from "@package/net/minecraft/client/gui/navigation";
