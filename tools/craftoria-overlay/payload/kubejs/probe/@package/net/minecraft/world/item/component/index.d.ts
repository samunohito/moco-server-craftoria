import { $DataResult, $MapEncoder, $DynamicOps, $Codec, $Codec_, $MapDecoder } from "@package/com/mojang/serialization";
...
import { $BundleContentsComponentAccessor, $BundleContentsComponentBuilderAccessor } from "@package/de/dafuqs/spectrum/mixin/accessors";
...
declare module "@package/net/minecraft/world/item/component" {
    ...
    export class $WrittenBookContent extends $Record implements $BookContent<$Component, $WrittenBookContent> {
        ...
        static pagesCodec(codec: $Codec_<$Component_>): $Codec<$List<$Filterable<$Component>>>;
    ...
    export class $BundleContents$Mutable implements $BundleContentsComponentBuilderAccessor {
        weight(): $Fraction;
    ...
    export class $BundleContents implements $TooltipComponent, $BundleContentsComponentAccessor {
        ...
        static invokeGetWeight$spectrum_$md$f87c94$0(stack: $ItemStack_): $Fraction;
