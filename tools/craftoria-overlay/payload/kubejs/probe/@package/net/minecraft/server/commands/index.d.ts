...
import { $BlockPos, $Holder_, $HolderSet$ListBacked, $Holder, $BlockPos_, $Holder$Reference, $Registry } from "@package/net/minecraft/core";
...
import { $BoundingBox, $Structure_, $Structure } from "@package/net/minecraft/world/level/levelgen/structure";
...
declare module "@package/net/minecraft/server/commands" {
    ...
    export class $LocateCommand {
        static register(dispatcher: $CommandDispatcher<$CommandSourceStack>, context: $CommandBuildContext): void;
        static getHolders(structure: $ResourceOrTagKeyArgument$Result<$Structure_>, structureRegistry: $Registry<$Structure_>): ($HolderSet$ListBacked<$Structure>) | undefined;
    ...
    export interface $TeleportCommand$LookAt {
        perform(source: $CommandSourceStack, entity: $Entity): void;
    }
    /**
