...
import { $ItemPropertiesInvoker } from "@package/com/kekecreations/jinxedlib/core/mixin";
...
declare module "@package/net/minecraft/client/renderer/item" {
    ...
    export class $ItemProperties implements $ItemPropertiesInvoker {
        ...
        static invokeRegister$jinxedlib_$md$f87c94$0(item: $Item_, name: $ResourceLocation_, property: $ClampedItemPropertyFunction_): void;
