...
import { $ETAStyle } from "@package/net/tysontheember/emberstextapi/accessor";
...
import { $Effect } from "@package/net/tysontheember/emberstextapi/immersivemessages/effects";
...
declare module "@package/net/minecraft/network/chat" {
    ...
    export class $HoverEvent$Action<T> implements $StringRepresentable {
        ...
        constructor(name: string, allowFromServer: boolean, codec: $Codec_<T>, legacyConverter: $HoverEvent$LegacyConverter_<T>);
        get serializedName(): string;
     ...
     */
    export class $Style implements $ETAStyle {
        /**
        ...
        emberstextapi$setEffects(arg0: $ImmutableList<any>): void;
        emberstextapi$getItemCount(): number;
        emberstextapi$getEffects(): $ImmutableList<any>;
