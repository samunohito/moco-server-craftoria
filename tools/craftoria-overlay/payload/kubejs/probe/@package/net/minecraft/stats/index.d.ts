...
declare module "@package/net/minecraft/stats" {
    export class $ServerRecipeBook extends $RecipeBook {
        ...
        handler$ijk000$nerb$onLoad(pState: $ClientboundRecipePacket$State_, pPlayer: $ServerPlayer, pRecipes: $List_<any>, ci: $CallbackInfo): void;
        handler$ijk000$nerb$onLoad(pTag: $CompoundTag_, pRecipeManager: $RecipeManager, ci: $CallbackInfo): void;
        handler$ijk000$nerb$onSave(cir: $CallbackInfoReturnable<any>): void;
    ...
    export class $RecipeBook {
        ...
        setOpen(bookType: $RecipeBookType_, filtering: boolean): void;
        handler$iji000$nerb$onCopy(pOther: $RecipeBook, ci: $CallbackInfo): void;
        constructor();
    }
    /**
