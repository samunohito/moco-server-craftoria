...
import { $PEType } from "@package/com/leclowndu93150/particle_effects/utils";
...
declare module "@package/net/minecraft/core/particles" {
    ...
    export class $SimpleParticleType extends $ParticleType<$SimpleParticleType> implements $ParticleOptions, $AccessSimpleParticleType, $PEType {
        static init$bookshelf_$md$f87c94$0(arg0: boolean): $SimpleParticleType;
