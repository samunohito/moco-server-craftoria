...
import { $EntityDimensions, $EntityType_, $Entity$RemovalReason, $PortalProcessor, $Pose_, $AgeableMob, $WalkAnimationState, $EntityType, $MobSpawnType_ } from "@package/net/minecraft/world/entity";
