...
declare module "@package/net/minecraft/world/level/storage/loot/predicates" {
    ...
    export class $LootItemRandomChanceWithEnchantedBonusCondition extends $Record implements $LootItemCondition {
         ...
         */
        getReferencedContextParams(): $Set<$LootContextParam<never>>;
        modifyReturnValue$hkd001$spectrum$applyRareLootEnchantment(arg0: boolean, arg1: $LootContext): boolean;
        modifyReturnValue$elh001$additionalentityattributes$additionalEntityAttributes$applyBonusLoot(arg0: boolean, arg1: $LootContext): boolean;
    ...
    export class $LootItemRandomChanceCondition extends $Record implements $LootItemCondition {
        ...
        modifyReturnValue$hkc000$spectrum$applyRareLootEnchantment(arg0: boolean, arg1: $LootContext): boolean;
        modifyReturnValue$elg000$additionalentityattributes$additionalEntityAttributes$applyBonusLoot(arg0: boolean, arg1: $LootContext): boolean;
    ...
    export class $LootItemKilledByPlayerCondition implements $LootItemCondition {
         ...
         */
        getReferencedContextParams(): $Set<$LootContextParam<never>>;
        handler$dba000$bookshelf$test(arg0: $LootContext, arg1: $CallbackInfoReturnable<any>): void;
